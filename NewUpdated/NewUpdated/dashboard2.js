...
const chartOptions6 = {
    ...
    xaxis: {
      ...
      labels: {
        style: {
          colors: 'white', // Set x-axis tick label text color to white
          fontSize: '12px' // Set x-axis tick label font size
        }
      }
    },
    yaxis: {
      title: {
        text: 'Appt. Power (KVAR)',
        style: {
          color: 'white', // Set y-axis label text color to white
          fontSize: '12px', // Set y-axis label font size
          fontWeight: 'normal'
        }
      },
      labels: {
        style: {
          colors: 'white', // Set y-axis tick label text color to white
          fontSize: '12px', // Set y-axis tick label font size
          fontWeight: 'normal'
        }
      }
    },
...
const chartOptions12 = {
    ...
    series: [
      {
        ...
        data: [] // Replace with your Power Factor data for L1
      },
      {
        name: 'Power Factor L2',
        data: [] // Replace with your Power Factor data for L2
      },
      {
        name: 'Power Factor L3',
        data: [] // Replace with your Power Factor data for L3
      }
    ],
    xaxis: {
      ...
      labels: {
        ...
        formatter: function (value, timestamp) {
          // Format the x-axis label to display timestamps in Malaysia time (UTC+8)
          var malaysiaTime = new Date(value);
          malaysiaTime.setHours(malaysiaTime.getHours() ); // Adjust to UTC+8
          return malaysiaTime.toLocaleTimeString();
        }
      },
      tooltip: {
    ...
    yaxis: {
      ...
      labels: {
        formatter: function (value) {
          // Format the y-axis label to display two decimal places
    ...
    tooltip: {
      x: {
        formatter: function (value) {
          // Format the tooltip to display the date and time in Malaysia time zone (UTC+8)
          var malaysiaTime = new Date(value);
          malaysiaTime.setHours(malaysiaTime.getHours() + 0); // Adjust to UTC+8
          return malaysiaTime.toLocaleString();
        },
      },
    },
    legend: {
